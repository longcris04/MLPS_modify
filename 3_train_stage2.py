...
class Trainer(object):
    ...
    def test(self, epoch, Is_GM):
        ...
        if self.args.dataset == 'luad':
            csv_filename = 'results_stage2_luad.csv'
        elif self.args.dataset == 'bcss':
            csv_filename = 'results_stage2_bcss.csv'
        # Save results to CSV
        ...
        # Extract per-class IoU and Dice scores
        iou_0, iou_1, iou_2, iou_3 = ious[0], ious[1], ious[2], ious[3]
        dice_0, dice_1, dice_2, dice_3 = Dice[0], Dice[1], Dice[2], Dice[3]
        # Append to dataframe
        new_row = {'iou_0': iou_0, 'iou_1': iou_1, 'iou_2': iou_2, 'iou_3': iou_3,
                   'miou': mIoU,
...
def main():
    ...
    parser.add_argument('--csv_dir', type=str, default='results/', help='Directory to save CSV results')
